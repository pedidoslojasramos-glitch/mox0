-- =============================================================================
-- SUPABASE SCHEMA SCRIPT FOR LOJAS RAMOS / RAMOX LOGÍSTICA
...
DO $$ BEGIN
    CREATE POLICY "Allow public read-write for branches" ON public.branches FOR ALL USING (true) WITH CHECK (true);
...
DO $$ BEGIN
    CREATE POLICY "Allow public read-write for branch_limits" ON public.branch_limits FOR ALL USING (true) WITH CHECK (true);
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN
    CREATE POLICY "Allow public read-write for branch_orders" ON public.branch_orders FOR ALL USING (true) WITH CHECK (true);
EXCEPTION WHEN duplicate_object THEN null; END $$;

DO $$ BEGIN
    CREATE POLICY "Allow public read-write for inventory_counts" ON public.inventory_counts FOR ALL USING (true) WITH CHECK (true);
EXCEPTION WHEN duplicate_object THEN null; END $$;

DO $$ BEGIN
    CREATE POLICY "Allow public read-write for distributions" ON public.distributions FOR ALL USING (true) WITH CHECK (true);
EXCEPTION WHEN duplicate_object THEN null; END $$;
